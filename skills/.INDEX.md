...
| `task-activate` | `task/activate/` | member |
| `task-create` | `task/create/` | member |
| `task-invalidate` | `task/invalidate/` | member |
| `task-list` | `task/list/` | member |
| `task-next` | `task/next/` | member |
| `task-prev` | `task/prev/` | member |
| `task-review` | `task/review/` | member |
| `task-status` | `task/status/` | member |
| `task` | `task/` | skillset |
| `task-validate` | `task/validate/` | member |
