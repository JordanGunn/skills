...
#   skills_dir:  Directory to scan (default: .codex/skills)
#   output_file: Output index file (default: .codex/skills/INDEX.md)
#
...
$SkillsRoot = (Resolve-Path "$ScriptDir\..\..").Path

if (-not $SkillsDir) { $SkillsDir = $SkillsRoot }
...
> Regenerate with: ``.codex/skills/index/scripts/index.sh`` or ``.codex/skills/index/scripts/index.ps1``
